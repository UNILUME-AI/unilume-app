...
const selectClass =
  "rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 focus:border-brand-400 focus:outline-none focus:ring-1 focus:ring-brand-400 transition-colors";
        ...
        <div className="flex flex-wrap gap-2">
          {displayKeywords.map((kw) => (
            <Link
              ...
              className="px-3 py-1.5 rounded-full bg-white border border-gray-200 text-sm text-brand-500 hover:border-brand-200 hover:bg-brand-50 transition-colors"
            >
              {kw}
            </Link>
          ))}
